...
<head>
    <meta charset="utf=8"/>
    <title>GULSEN-LOGIN</title>
    <link rel="stylesheet" type="text/css" href="home.css" me2dia="screen" />
    <link rel="stylesheet" type="text/css" href="demo.css" me2dia="screen" />    
    <link rel="stylesheet" type="text/css" href="login.css" me2dia="screen" />  
    <center><h1>GUSLEN</h1></center>
    <center>
        <nav>
...
<H1>Your Username and/or Password was incorrect.  Please try again.</H1>
...
<form>
    ...
    <p>
        <input id="login" type="submit" value="Login" onclick="checkLogin(); return false;" />
    </p>
</form>



<!--Interface for creating a user: http://jqueryui.com/dialog/#modal-form-->
